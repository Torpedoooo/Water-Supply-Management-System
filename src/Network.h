...
public:
    ...
    /**
     * Calculates which pumping stations can be temporarily removed without affecting the delivery capacity to all the cities
     * @return a list with the codes of the pumping stations
     */
