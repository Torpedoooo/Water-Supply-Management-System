...
\item 
void \mbox{\hyperlink{classGraph_a468b6d9b6b1899d4c885324ed14e4f8a}{dfs\+Visit}} (\mbox{\hyperlink{classVertex}{Vertex}}$<$ T $>$ $\ast$v, std\+::vector$<$ T $>$ \&res) const
\item 
...
Auxiliary function that visits a vertex (v) and its adjacent, recursively. Returns false (not acyclic) if an edge to a vertex in the stack is found. \mbox{\Hypertarget{classGraph_a468b6d9b6b1899d4c885324ed14e4f8a}\label{classGraph_a468b6d9b6b1899d4c885324ed14e4f8a}} 
...
{\footnotesize\ttfamily template$<$class T $>$ \\
void \mbox{\hyperlink{classGraph}{Graph}}$<$ T $>$\+::dfs\+Visit (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classVertex}{Vertex}}$<$ T $>$ $\ast$}]{v,  }\item[{std\+::vector$<$ T $>$ \&}]{res }\end{DoxyParamCaption}) const}
